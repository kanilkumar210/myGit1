...
<body>
	...
	<sql:query dataSource="${dbsource}" var="result">
            SELECT user.* from user inner join corporate_setup on user.corporate_id=corporate_setup.corporate_id where  user.is_active=1 and corporate_setup.corporate_name='${id}' and user.roles!='ROLE_ADMIN';
	...
	<div class="container">
		...
		</a> <a href="adminHome"><button class="button1">Admin Home</button></a> <a
			href="/logout"><button class="button3">Log Out</button></a>
		<div class="row">
			<hr>
				...
				<tbody>
					<c:forEach items="${result.rows}" var="user">
						<tr>
							...
							<td><a
								href="deleteUser?id=${user.login_id}&corId=${user.corporate_id}"
