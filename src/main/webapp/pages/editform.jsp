	...
	<div class="container">
		<div class="row">
			<h1 style="font-size: 40px; text-align: center;">Update
				Corporate</h1>
			<a href="/logout"><button class="button3">Log Out</button></a>
			<hr>
			<div class="col-md-4 offset-4">
				<form action="/editCorporate" modelAttribute="corporateBean">
					<input type="hidden" name="Corporate_id"
						value="${corporateBean.corporate_id}" /> <label
						class="form-group">CorporateName: <input type="text"
						name="corporateName" value="${corporateBean.corporateName}"
						class="form-control" readonly="readonly" /> <label
						class="form-group">Address:</label> <input type="text"
						name="address" value="${corporateBean.address}"
						...
						required="required" value="${corporateBean.phoneNumber}"
						class="form-control" />
