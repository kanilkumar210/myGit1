...
<body>
	...
	SELECT * FROM account_setup inner join corporate_setup on account_setup.corporate_id=corporate_setup.corporate_id where corporate_name='${id}' and account_setup.is_active=1;
	</sql:query>
	...
	<div class="container">
		...
		</a> <a href="adminHome"><button class="button2">Admin Home</button> </a>
				...
				<table class="table table-striped" style="text-align: center;">
					...
					<c:forEach var="row" items="${result.rows}">
						<tr>
							...
							<td><a
								href="closeAccount?id=${row.account_number}&corname=${row.corporate_name}"><button
										type="button"
