...
<body>
	...
	<div class="container">
		<a href="adduserform"><button class="abc1">Add Corporate</button></a>
		<a href="adminHomePage"><button class="abc2">Admin Home</button></a> <a
			href="/logout"><button class="abc3">Log Out</button></a>
		...
		<table class="table table-striped" style="text-align: center;">
			...
			<c:forEach items="${corporateList}" var="u">
				<tr>
					<td>${u.getCorporate_id()}</td>
					<td>${u.getCorporateName()}</td>
					<td>${u.getAddress()}</td>
					<td>${u.getPhoneNumber()}</td>
					<td><a href="editform?id=${u.getCorporate_id()}"><button
								type="button"
								style="background-color: green; border-radius: 80px; color: white;">Update</button></a></td>
					<td><a href="deleteCorporate?id=${u.getCorporate_id()}"><button
								type="button"
