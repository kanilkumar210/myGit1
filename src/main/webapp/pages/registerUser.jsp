...
<body style="background-color: lightgreen;">
	...
	<div class="container">
		<div class="row">
			...
			<a href="getUsers"><button class="abc3">Back</button></a>
			<hr>
			<div class="col-md-4 offset-4">
				<form action="addUserDetails" modelAttribute="userBean">
					<p style="color: red;">
					...
					<div class="form-group">
						<label for="loginId">Login Id</label> <input type="number"
							class="form-control" placeholder="Login Id" name="login_id"
							required="required">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="mobNumber">Mobile Number</label> <input type="tel"
							...
							name="mobileNumber" pattern="[0-9]{10}" title="Ten digits code">
					</div>
					<div class="form-group">
